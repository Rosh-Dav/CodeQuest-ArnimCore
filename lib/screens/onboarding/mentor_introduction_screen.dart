...
import 'package:flutter_tts/flutter_tts.dart'; // Added back for TTS support
...
class _MentorIntroductionScreenState extends State<MentorIntroductionScreen> {
  ...
  Future<void> _beginJourney() async {
    ...
    // Otherwise, fall back to existing logic for other modes
    if (widget.selectedStoryMode == 'Byte Star Arena' || widget.selectedStoryMode == 'ByteStar Arena') {
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          // If story already started, go to map? Or use my placeholder?
          // For now, respect Remote's MissionMapScreen
  ...
  Widget build(BuildContext context) {
    // Handle both spelling variations if present in data
    final bool isByteStar = widget.selectedStoryMode == 'ByteStar Arena' || widget.selectedStoryMode == 'Byte Star Arena';
